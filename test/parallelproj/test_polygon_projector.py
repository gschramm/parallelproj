...
def test_polygon_projector(xp: ModuleType, dev: str) -> None:
    ...
    assert proj.out_shape == (lor_desc.num_rad, lor_desc.num_views, lor_desc.num_planes, tof_params.num_tofbins)
    ...
    proj2 = parallelproj.RegularPolygonPETProjector(lor_desc, img_shape, voxel_size, views = views, img_origin = img_origin)
