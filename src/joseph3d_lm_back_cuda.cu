 ...
 *  @param p           array of length np containg the values to be back projected
 ...
 *  @param h_p           array of length np containg the values to be back projected
 *  @param np          number of projections (length of p array)
