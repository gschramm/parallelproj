/**
 * @file joseph3d_tof_sino_back_cuda.cu
 */
 ...
 */
__global__ void joseph3d_tof_sino_back_cuda_kernel(float *xstart, 
                                                   float *xend, 
                                                   float *img,
                                                   float *img_origin, 
                                                   float *voxsize,
 ...
 */
extern "C" void joseph3d_tof_sino_back_cuda(float *h_xstart, 
                                            float *h_xend, 
                                            float *h_img,
                                            float *h_img_origin, 
                                            float *h_voxsize, 
                                            ...
                                            int num_devices)
{
  ...
  for (unsigned int i_dev = 0; i_dev < num_devices; i_dev++) 
  {
    ...
    // call the kernel
    joseph3d_tof_sino_back_cuda_kernel<<<grid,block>>>(d_xstart[i_dev], d_xend[i_dev], d_img[i_dev],
