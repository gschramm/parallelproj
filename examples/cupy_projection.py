...
parser.add_argument('--voxsize',
                    ...
                    default=['2', '2', '2'],
                    nargs='+')
parser.add_argument('--threads_per_block',
...
joseph3d_fwd_cuda_kernel((blocks_per_grid, ), (threads_per_block, ),
                         (xstart_d, xend_d, img_ravel_d, img_origin_d,
                          voxsize_d, img_fwd_d, subset_nLORs, img_dim_d))

joseph3d_back_cuda_kernel((blocks_per_grid, ), (threads_per_block, ),
                          (xstart_d, xend_d, bimg_ravel_d, img_origin_d,
                           voxsize_d, img_fwd_d, subset_nLORs, img_dim_d))
