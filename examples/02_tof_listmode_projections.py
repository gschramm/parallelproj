...
# Every event line of response (LOR) along which we want to project is
# defined by its start point (3 element array) and end point (3 element array).
# Here we define 2 event LORs and group all start and end points in two
...
parallelproj.joseph3d_fwd_tof_lm(xstart, xend, img, img_origin,
...
# setup an array of ones
sino = xp.ones_like(img_fwd)

parallelproj.joseph3d_back_tof_lm(xstart, xend, back_img, img_origin,
