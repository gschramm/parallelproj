...
parser.add_argument('--seed',
                    ...
                    default=1,
                    type=int)
parser.add_argument('--rel_gamma',
                    help='relative step size ratio',
                    default=30,
                    type=float)
parser.add_argument('--beta', help='prior strength', default=0.1, type=float)
parser.add_argument('--norm',
                    help='name of gradient norm',
                    default='l2_l1',
                    choices=['l2_sq', 'l2_l1'])
parser.add_argument('--use_structure',
                    help='use structural info for prior',
                    action='store_true')
...
ax[0, 3].plot(np.arange(niter + 1 - 5, niter + 1),
              cost2[-5:],
              label='rho = 4/3')
